...
import { GET_ALL_BRANDS, CREATE_NEW_BRAND, DELETE_BRAND } from "../../../../conf/main";
  ...
  const handleCreateBrand = async () => {
    ...
    try {
      ...
      if (response.data.createBrand) {
        console.log("Brand created:", response.data.createBrand.BrandName);
            ...
            <div className="gap-6 md:grid-cols-3">
              <div className="md:col-span-2 space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  onClick={() => {handleRemoveBrand(brand.documentId)}}
                >
                    <svg
